...
부트스트랩이 끝나면 **펌웨어 파서(모듈 핀아웃 DB)로 간다.**
차별 규칙 R7·R8·R1·R5가 전부 거기에 걸려 있다.

> ⚠️ 원래 이 자리에는 "배포 URL 확보가 펌웨어 파서보다 먼저다"라고 적혀 있었습니다.
> **지금 판단은 반대입니다.** 돌아가는 규칙이 없으면 배포된 URL도 보여줄 게 없습니다.
> 배포는 후순위로 미룹니다.
