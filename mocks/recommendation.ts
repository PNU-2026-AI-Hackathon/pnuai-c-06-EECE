...
export const mockRecommendations: Mock<Recommendation>[] = [
  {
    ...
    type: "inventory",
    priority: "high",
    action: "이번 주 안주 재료 발주량을 평소의 70% 수준으로 조정할지 확인해 보세요",
    description:
      "시험 기간에는 매출이 크게 줄어 재료가 남을 수 있습니다. 닭발과 오돌뼈가 지난주 매출의 45%를 차지했는데, 시험 주에도 이 비중이 유지될지는 확실하지 않습니다. 현재 재고와 납품 일정을 보고 정해 주세요.",
    evidence: [
      {
  ...
  },
  {
    ...
    type: "staff",
    priority: "medium",
    action: "화요일과 수요일 근무 인원을 지금 그대로 둘지 확인해 보세요",
    description:
  ...
  },
  {
    ...
    type: "marketing",
    priority: "high",
    action: "금요일(10월 24일) 오후 5시 홍보를 준비해 보세요",
    description:
