...
| 플랜 | 대상 | 핵심 |
|---|---|---|
| **무료** | 학생 · 개인 | 검사 무제한 · 판정마다 근거와 출처 · 결과 보관과 링크 공유 · 비공개 전환 |
| **Pro** — 9,900원/월 | 1인 개발자 · 소규모 팀 | **API 키** · **GitHub 연동** — PR 마다 자동 검사, 머지 차단 |
| **팀** — 39,000원/월 | 회사 | 조직 계정 · 사내 부품 사실 등록 · 사내 규칙 추가 |

**결제는 아직입니다.** 사업자등록 전이라 결제 대행 계약을 못 맺었고, 그동안은
**Pro 기능도 열어 두고 있습니다.** 요금 화면에도 그대로 적혀 있습니다 — 막지 않으면서
막는다고 적는 것이 거짓말이라고 봤습니다.

#### 시장은 어디에 있는가

**저희 자리는 두 시장 사이입니다.** 회로도를 그리고 검사하는 도구가 한쪽에,
코드를 읽고 결함을 찾는 도구가 다른 쪽에 있습니다. **둘 다 이미 시장입니다.**

| | 2025년 세계 시장 | 성장 | 이 자리의 도구들 |
|---|---:|---:|---|
| 회로도 쪽 | **약 5.7조원** ($4.1B)<sup>[2]</sup> | 연 13.7% | KiCad · Altium · Traceformer · Flux |
| 코드 쪽 | **약 1.6조원** ($1.13B)<sup>[3]</sup> | 연 3.6% | Coverity · Polyspace · SonarQube |
| **그 사이** | **이름 붙은 시장이 없습니다** | — | **없습니다** |

회로도 도구는 코드를 안 읽고, 코드 분석기는 회로도를 모릅니다.
**저희가 파는 것은 이 두 시장 중 하나가 아니라 그 사이입니다.**

**국내로 좁히면 셀 수 있는 데까지만 적습니다.**

| 셀 수 있는 것 | 숫자 | 출처 |
|---|---:|---|
| 2024년 국내 제조업 창업 | 35,087개 (전년 대비 −5.9%) | 중기부 창업기업동향<sup>[4]</sup> |
| 시제품 제작을 돕는 메이커스페이스 | 163곳 | 공공데이터포털<sup>[5]</sup> |
| 그중 한 곳(서울 용산)의 2023년 실적 | 64개 기업 · 전자보드 34,000개 | 1.1 참조 |

**그중 전자보드를 만드는 팀이 몇인지는 저희가 모릅니다.** 정부 통계에 세부업종
구분이 없습니다. **163 곱하기 64 같은 계산은 하지 않았습니다** — 용산은 큰 곳이라
평균이 아니고, 근거 없는 곱셈을 하는 순간 이 문서가 파는 것과 모순됩니다.
...
<sub>[2] SNS Insider, <a href='https://www.snsinsider.com/reports/pcb-design-software-market-8852'>PCB Design Software Market</a> — 2025년 $4.08B. 환율 1,390원 적용.</sub>
<sub>[3] The Business Research Company, <a href='https://www.thebusinessresearchcompany.com/report/static-code-analysis-software-global-market-report'>Static Code Analysis Software Market</a> — 2025년 $1.13B.</sub>
<sub>[4] 중소벤처기업부, <a href='https://www.korea.kr/briefing/pressReleaseView.do?newsId=156676794'>「2024년 연간 창업기업동향」</a> (2025.02)</sub>
<sub>[5] 공공데이터포털, <a href='https://www.data.go.kr/data/15048983/fileData.do'>창업진흥원 메이커스페이스 주관기관 정보</a> — 등록 기관 163개</sub>
...
<table>
<tr>
<td align="center" width="20%"><img src="docs/team/권지효.jpg" width="130" alt="권지효"/></td>
<td align="center" width="20%"><img src="docs/team/한지양.jpg" width="130" alt="한지양"/></td>
<td align="center" width="20%"><img src="docs/team/유동훈.jpg" width="130" alt="유동훈"/></td>
<td align="center" width="20%"><img src="docs/team/조우진.jpg" width="130" alt="조우진"/></td>
<td align="center" width="20%"><img src="docs/team/박강현.jpg" width="130" alt="박강현"/></td>
</tr>
<tr>
<td align="center"><b>권지효</b><br/>팀장</td>
<td align="center"><b>한지양</b></td>
<td align="center"><b>유동훈</b></td>
<td align="center"><b>조우진</b></td>
<td align="center"><b>박강현</b></td>
</tr>
</table>

| | 권지효 | 한지양 | 유동훈 | 조우진 | 박강현 |
|---|:---:|:---:|:---:|:---:|:---:|
| 전공 | 전기공학 | 전자공학 | 컴퓨터공학 | 컴퓨터공학 | 컴퓨터공학 |
| 역할 | **팀장** · Hardware / Validation | Hardware / Rules | Backend | Backend | **Full-stack** · 배포 |
| 맡은 일 | 검증 데이터셋 라벨링<br/>데모 보드 설계<br/>오탐 검수 | 규칙 정의<br/>데이터시트 근거 확보<br/>오탐 판정 | 넷리스트·펌웨어 파서<br/>데이터시트 파이프라인 | 모듈 핀아웃 DB<br/>R07 · R08 구현<br/>진단 워크플로 | 웹 전체 · REST API · 인증<br/>규칙 엔진 · GitHub 연동<br/>CI 3종 · 배포 · 문서 |
| 메일 | cofls0103@pusan.ac.kr | sheis21030@pusan.ac.kr | ehdgns1083@gmail.com | bswoojin@gmail.com | ks922324@pusan.ac.kr |

**규칙의 정확성은 하드웨어 담당 두 명이 책임집니다.** 무엇이 위험한지 정의하고,
데이터시트 어느 표의 어느 값을 봐야 하는지 명시하고, 검출 결과가 진짜인지 판정합니다.
**오탐 검수가 이 프로젝트에서 가장 중요한 지속 업무입니다.**

이 판단은 커밋으로 남지 않습니다. R15 는 하드웨어 담당의 보드에서 릴레이가 안 꺼진
일에서 나왔고, 반대로 채택하지 않은 규칙(R13)도 같은 사람의 판정이었습니다.
**위험하지 않은 것을 규칙으로 만들지 않는 결정이 규칙을 하나 더 만드는 것보다 중요합니다.**

구현은 한 사람에게 몰려 있습니다. 저장소 기준 **커밋 318개 중 289개, 코드·문서
변경분의 93%가 박강현**이고, 웹·API·규칙 엔진·CI·배포·문서가 여기 해당합니다.
숨길 이유가 없어 그대로 적습니다 — 커밋 그래프에 다 남아 있습니다.
...
- **권지효** · 팀장
  > 규칙을 늘리는 것보다 **빼는 결정**이 어려웠습니다. 오탐을 45건에서 0으로 줄이고
  > 좋아했는데, 그 숫자를 튜닝에 쓴 것과 **같은 보드 6개**에서 재고 있었다는 걸 뒤늦게
  > 알았습니다. 처음 보는 보드 38개에 다시 대니 14건이 나왔습니다. 그때 우리가 우리를
  > 속이고 있었다는 게 제일 아팠고, 그 뒤로는 무엇을 재고 있는지 먼저 적고 시작했습니다.
  >
  > 팀장으로서 배운 것은 **결정을 미루지 않는 것**이었습니다. 해커톤은 시간이 정해져
  > 있어서, 애매한 채로 두면 그게 그대로 마감까지 갑니다. 규칙을 넣을지 말지, 어떤 기능을
  > 버릴지를 그날 안에 정하고 이유를 적어 뒀더니 나중에 같은 논쟁을 다시 하지 않았습니다.

- **한지양** · Hardware / Rules
  > 제 보드에서 LED 가 켜지는데 안 꺼졌습니다. 3.3V 가 릴레이 문턱에 못 미친 거였고,
  > 그게 규칙 하나(R15)가 됐습니다. 반대로 **넣지 않기로 한 규칙**도 있습니다.
  > 출력이 겹치는 자리를 잡자는 제안이 왔는데 그 보드에서는 위험하지 않아서 기각했습니다.
  > 위험하지 않은 것을 규칙으로 만들면 그게 오탐 생성기가 됩니다.
  >
  > 하드웨어를 하는 사람과 소프트웨어를 하는 사람이 **같은 단어를 다르게 쓰고 있다는 것**을
  > 이번에 알았습니다. 제가 "이 핀은 위험하다"고 하면 상대는 그걸 코드로 어떻게 판정할지
  > 물었고, 그 질문에 답하려면 제가 아는 것을 데이터시트 몇 쪽 몇 표까지 좁혀야 했습니다.
  > 막연히 알던 것을 남이 검증할 수 있는 형태로 바꾸는 연습이었습니다.

- **유동훈** · Backend
  > 파서를 만들면서 제일 많이 쓴 코드는 **"모르겠다"를 돌려주는 부분**이었습니다.
  > 넷리스트 형식이 도구마다 다른데, 못 읽은 것을 빈 결과로 넘기면 검사가 조용히
  > 통과해 버립니다. 못 읽었으면 못 읽었다고 결과에 싣도록 규약을 따로 만들었고,
  > 그게 이 프로젝트에서 배운 것 중 제일 오래 남을 것 같습니다.
  >
  > 짧은 기간에 만들다 보면 **"일단 되게" 하고 싶은 유혹**이 계속 옵니다. 실제로 몇 번
  > 그렇게 넘어갔다가 뒤에서 더 큰 비용으로 돌아왔습니다. 마감이 가까울수록 오히려
  > 규약을 지키는 편이 빨랐다는 게, 머리로 알던 것과 달리 몸으로 겪은 부분입니다.

- **조우진** · Backend
  > 판정 경로에 LLM 을 두지 않기로 한 결정이 계속 옳았습니다. 같은 파일을 넣으면 언제나
  > 같은 답이 나와야 하는데, 그 성질이 없으면 CI 에 붙일 수 없습니다. 대신 검사 원가가
  > 0에 가까워져서 웹 검사를 무제한 무료로 열 수 있었습니다. **제약이 오히려 제품을
  > 만들어 준 경우**였습니다.
  >
  > 그리고 **혼자 결정하지 않는 법**을 배웠습니다. 규칙의 정확성은 제가 판단할 수 없어서
  > 하드웨어 담당의 판정을 받아야 했고, 처음에는 그게 느리게 느껴졌습니다. 그런데 제가
  > 맞다고 생각한 것이 실제로는 아니었던 경우가 여러 번 나왔습니다. 전공이 다른 사람이
  > 한 팀에 있다는 것의 값을 이번에 처음 실감했습니다.

- **박강현** · Frontend
  > 화면이 *"주소를 아는 사람도 열 수 없습니다"* 라고 적고 있었는데, 쿠키 없이 그 주소를
  > 열어 보니 열렸습니다. 개인정보에 관한 문장이라 그날 바로 고쳤습니다. 그 뒤로 새 문장을
  > 쓸 때마다 **"이게 참이라는 걸 응답의 어느 필드가 보장하나"** 를 먼저 물었습니다.
  > 예쁘게 만드는 것보다 이게 훨씬 어려웠습니다.
  >
  > 해커톤 내내 가장 많이 한 일은 **만드는 것이 아니라 지우는 것**이었습니다. 넣고 싶은
  > 화면과 기능이 계속 생겼는데, 그중 대부분은 우리가 아직 근거를 못 대는 것들이었습니다.
  > 제한된 시간에 무엇을 안 할지 정하는 것이 무엇을 할지 정하는 것보다 어렵다는 걸,
  > 마감이 있는 프로젝트에서 처음 배웠습니다.
