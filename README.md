...
| 역할 | **팀장** · Hardware / Validation | Hardware / Rules | Backend | Backend | Frontend |
| 맡은 일 | 검증 데이터셋 라벨링<br/>데모 보드 설계<br/>오탐 검수 | 규칙 정의 및 구현<br/>데이터시트 근거 확보<br/>오탐 검수 | 넷리스트·펌웨어 파서<br/>데이터시트 파이프라인 | REST API<br/>규칙 엔진<br/>인프라 | 업로드·리포트 UI<br/>발견 카드<br/>디자인 시스템 |
